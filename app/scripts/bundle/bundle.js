...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1),
	    ReactDOMServer = __webpack_require__(158),
	    HomePage = __webpack_require__(159);

	ReactDOM.render(React.createElement(HomePage, { blip: window.APP_PROPS }), document.getElementById('app'));
	...
	module.exports = React.createClass({
	    ...
	    render: function () {
	        return React.createElement(
	            ...
	            React.createElement(PostContent, { name: this.state.name, desc: this.state.desc, lorem: this.state.lorem, blip: this.state.blip })
	        );
	    }
	});
	...
	var PostContent = React.createClass({
	    ...
	    render: function () {
	        return React.createElement(
	            ...
	            React.createElement(
	                "h2",
	                { className: "post-content--h2 font-N7" },
	                this.props.blip
	            )
	        );
	    }
